...
const OPENMODEL_KEYS = ['ANTHROPIC_AUTH_TOKEN', ...Object.keys(OPENMODEL_ENV), ...Object.keys(OPENMODEL_BRIDGE_ENV), 'ANTHROPIC_BASE_URL', 'ANTHROPIC_API_KEY', 'ANTHROPIC_MODEL'];
